...
// Handle comment submission - VULNERABILITY: Stored XSS
        ...
        <div class="artwork-card">
            ...
            <div class="p-6">
                ...
                <details class="mt-4">
                    ...
                    <!-- Display Comments - VULNERABILITY: XSS -->
                    <div class="mt-3 space-y-2">
                        <?php foreach($comments as $c): ?>
                            <?php if($c['artwork_id'] == $art['id']): ?>
                            <div class="bg-black/30 rounded p-2 text-sm">
                                <span class="gold-text"><?php echo $c['username']; ?>:</span>
                                <span class="text-gray-300"><?php echo $c['comment']; ?></span>
                            </div>
                            <?php endif; ?>
                        <?php endforeach; ?>
                    </div>
