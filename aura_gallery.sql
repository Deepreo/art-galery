...
--
-- Anamakine: 127.0.0.1
-- Üretim Zamanı: 13 Şub 2026, 09:49:33
...
(3, 1, 'guest', 'Tablolar çok güzel duruyor ama neden bu kadar pahalı', '2026-01-23 08:43:47'),
(4, 2, 'guest', 'Bu sanat galerisi çok vizyoner', '2026-02-06 22:05:54');
...
(1, 2, 'artist', 'HER SEY GORUNDUGU GIBI DEGIL', '2026-01-23 15:37:16'),
(2, 7, 'flagger', 'FLAG: DEEPREO{G1ZL1-<!--V3R1--!>-K4LM4D1}', '2026-01-26 16:09:27'),
(5, 1, 'admin', 'Bugün ziyaret oldukça tatmin edici', '2026-02-06 22:10:24'),
(6, 1, 'admin', 'Sanat sanat için mi, yoksa benim için mi :D', '2026-02-06 22:11:11'),
(8, 3, 'collector', 'Burada çok tuhaf şeyler oluyor ', '2026-02-02 08:13:07'),
(9, 7, 'flagger', 'Başarı asla pes etmeyenlerin rutinidir :)', '2026-02-02 08:14:48');
